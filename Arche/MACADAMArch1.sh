#!/bin/bash
# This bash script downloads all RefSeq archeal genomes.
...
wget -nv -P downloads https://ftp.ncbi.nlm.nih.gov/genomes/refseq/archaea/assembly_summary.txt
