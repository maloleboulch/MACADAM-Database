...
#Open CSV files
with open("./DatabaseTSV/allnamesremasteredImport.tsv","r") as inputfile:
...
with open("./DatabaseTSV/PathwayHierarchy.tsv","r") as inputfile:
    csvPathway=csv.reader(inputfile,delimiter='\t')
    for t in csvPathway:
...
with open("./DatabaseTSV/PWY.RXN.tsv","r") as inputfile:
    csvPathway=csv.reader(inputfile,delimiter='\t')
    for t in csvPathway:
        dbToolsCursor.execute('INSERT INTO  PWYRXN VALUES (?,?)', t)

with open("./DatabaseTSV/RXN.Name.tsv","r") as inputfile:
    csvPathway=csv.reader(inputfile,delimiter='\t')
    for t in csvPathway:
        dbToolsCursor.execute('INSERT INTO  RXNName VALUES (?,?)', t)

with open("./DatabaseTSV/RXN.CPD.tsv","r") as inputfile:
    csvPathway=csv.reader(inputfile,delimiter='\t')
    for t in csvPathway:
        dbToolsCursor.execute('INSERT INTO  RXNCPD VALUES (?,?)', t)

with open("./DatabaseTSV/CPD.Name.tsv","r") as inputfile:
    csvPathway=csv.reader(inputfile,delimiter='\t')
    for t in csvPathway:
        dbToolsCursor.execute('INSERT INTO  CPDName VALUES (?,?)', t)

with open("./DatabaseTSV/RXN.ENZ.tsv","r") as inputfile:
    csvPathway=csv.reader(inputfile,delimiter='\t')
    for t in csvPathway:
        dbToolsCursor.execute('INSERT INTO  RXNENZ VALUES (?,?)', t)

with open("./DatabaseTSV/ENZName.tsv","r") as inputfile:
    csvPathway=csv.reader(inputfile,delimiter='\t')
    for t in csvPathway:
        dbToolsCursor.execute('INSERT INTO  ENZName VALUES (?,?)', t)

with open("./DatabaseTSV/IJSEMphenodb.tsv","r") as inputfile:
    csvPathway=csv.reader(inputfile,delimiter='\t')
    for t in csvPathway:
